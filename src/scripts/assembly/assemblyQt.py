...
# Form implementation generated from reading ui file '../Dropbox/Projects/GRACy/GRACy_UI/assembly.ui'
#
...
class Ui_Form(object):
	def setupUi(self, Form, installationDirectory):
		...
		self.label_2.setGeometry(QtCore.QRect(560, 20, 201, 20))
		self.label_2.setObjectName("label_2")
		self.label_3 = QtWidgets.QLabel(Form)
		self.label_3.setGeometry(QtCore.QRect(560, 90, 181, 20))
		self.label_3.setObjectName("label_3")
		self.memoryCombo = QtWidgets.QComboBox(Form)
		self.memoryCombo.setGeometry(QtCore.QRect(560, 110, 71, 28))
		...
		self.label_4.setGeometry(QtCore.QRect(560, 160, 211, 20))
		self.label_4.setObjectName("label_4")
		self.intermediateFilesCombo = QtWidgets.QComboBox(Form)
		self.intermediateFilesCombo.setGeometry(QtCore.QRect(560, 180, 90, 28))
		self.intermediateFilesCombo.setObjectName("intermediateFilesCombo")
		self.intermediateFilesCombo.addItem("")
		self.intermediateFilesCombo.addItem("")
		self.label_5 = QtWidgets.QLabel(Form)
		self.label_5.setGeometry(QtCore.QRect(30, 360, 76, 20))
		self.label_5.setObjectName("label_5")
		self.logArea = QtWidgets.QTextEdit(Form)
		self.logArea.setGeometry(QtCore.QRect(20, 380, 521, 231))
	...
	def performAssembly(self):
		if str(self.selectedFilesArea.toPlainText()) == "":
			...
			msg.setDetailedText("You should select at least one denovo configuration file\n ")
	...
	def retranslateUi(self, Form):
		...
		self.label.setText(_translate("Form", "Configuration files"))
		...
		self.label_2.setText(_translate("Form", "Number of threads"))
